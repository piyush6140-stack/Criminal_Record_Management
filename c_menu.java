...
public class menu {
    ...
    public static void addcriminal()
    {
        ...
        JTextField shoname,stationid,criminalname,city,state,aadhaarno,district;
...
//	        f1.pack();
	        ...
	        addcriminal.setBounds(240,150, 200,200);
	        
	        JLabel AC= new JLabel("ADD CRIMINAL");	
			AC.setBounds(285,360,120,30);
